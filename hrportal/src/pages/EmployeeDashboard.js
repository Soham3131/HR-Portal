...
//             const isMobileUA = /Android|iPhone|iPad|iPod|Opera Mini|IEMobile/i.test(userAgent);
//             const isMobileNormal = isMobileUA && isTouchDevice && screenWidth < 800;

//             setIsMobileBlocked(isMobileNormal); // Block only if in mobile normal mode

//             // Send device info to backend
//             api.post('/employee/device-log', {
//                 userAgent,
//                 isTouchDevice,
//                 screenWidth,
//                 isMobileUA,
...
//                 timestamp: new Date(),
//             }).catch(err => {
//                 console.warn('Device log failed:', err.message);
//             });
//         };
...
//             setTodayAttendance(updatedRecord);
//             setAttendance(prev =>
//                 prev.map(att => att._id === updatedRecord._id ? updatedRecord : att)
//             );
//         } catch (error) {
//             console.error("Check-out failed:", error);
//             alert(error.response?.data?.message || 'Check-out failed');
...
//             <div className="flex flex-col items-center justify-center h-[60vh] text-center p-4">
//                 <h1 className="text-2xl font-bold text-red-600">Access Restricted on Mobile</h1>
//                 <p className="mt-4 text-gray-700">Please open the site in Desktop Site mode to mark attendance.</p>
//             </div>
//         );
//     }
