...
//         uploadData.append('upload_preset', 'employee_portal'); // Create this preset in your Cloudinary account
//         uploadData.append('cloud_name', 'dhvhqgdrc'); // Your cloud name
...
//                     <p className="text-gray-600">{profile.department} - {profile.employeeId}</p>
//                 </div>
//             </div>

//             {uploading && <div className="flex items-center space-x-2"><Spinner /><p>Uploading...</p></div>}
...
//                 <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
//                     <p><span className="font-semibold">Joining Date:</span> {profile.joiningDate ? new Date(profile.joiningDate).toLocaleDateString() : 'N/A'}</p>
//                     <p><span className="font-semibold">Salary:</span> {profile.salary ? `₹${profile.salary.toLocaleString()}` : 'Not Disclosed'}</p>
//                 </div>
//             </Card>
...
//                         {profile.idProofUrl ? (
//                             <a href={profile.idProofUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">View ID Proof</a>
//                         ) : (
//                             <input type="file" onChange={(e) => handleFileChange(e, 'idProof')} />
//                         )}
//                     </div>
//                     <div>
//                         <h3 className="font-semibold">Marksheets & Other Documents</h3>
//                         <ul className="list-disc list-inside">
//                             {(profile.documents || []).map((doc, index) => (
//                                 <li key={index}><a href={doc.url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">{doc.name}</a></li>
//                             ))}
//                         </ul>
//                         <div className="mt-2">
//                             <label htmlFor="marksheet-upload">Upload New Document:</label>
//                             <input id="marksheet-upload" type="file" onChange={(e) => handleFileChange(e, 'marksheet')} />
//                         </div>
//                     </div>
//                 </div>
//             </Card>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-sky-100 to-blue-200 dark:from-gray-900 dark:to-gray-800 px-6 py-12">
            ...
            >
                ...
                {/* <Card>
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Employment Details</h2>
