...
//     setError('');
//     try {
//       // Get the user's device info from the browser
//       const deviceInfo = role === 'employee' ? navigator.userAgent : undefined;
      
//       // Pass all data to the login function in the context
...
//               className={`w-1/2 py-2 rounded-md text-sm font-medium ${role === 'employee' ? 'bg-blue-600 text-white' : 'text-gray-600'}`}
//             >
//               Employee
//             </button>
//             <button 
//               onClick={() => setRole('hr')}
//               className={`w-1/2 py-2 rounded-md text-sm font-medium ${role === 'hr' ? 'bg-blue-600 text-white' : 'text-gray-600'}`}
//             >
//               HR Admin
//             </button>
//           </div>
