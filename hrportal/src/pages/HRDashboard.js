...
//                     <h2 className="text-xl font-semibold text-gray-700">Daily Attendance Log</h2>
//                     <div className="mt-4 sm:mt-0">
//                         <label htmlFor="filterDate" className="mr-2 text-sm font-medium">Filter by Date:</label>
//                         <input type="date" id="filterDate" value={filterDate} onChange={(e) => setFilterDate(e.target.value)} className="border border-gray-300 rounded-md p-2"/>
//                     </div>
//                 </div>
...
//                         </li>
//                     )) : <p className="text-gray-500">All employees have marked their attendance.</p>}
//                 </ul>
//             </Modal>
...
//                             <p className="text-sm text-gray-500">{rec.employeeId.email}</p>
//                         </li>
...
//                             {employees.map(emp => (
//                                 <tr key={emp._id}>
//                                     <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">{emp.employeeId}</td>
