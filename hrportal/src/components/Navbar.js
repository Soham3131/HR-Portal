    ...
    <nav className="bg-gradient-to-r from-white to-blue-50 shadow-md sticky top-0 z-50 font-sans animate-fade-in-down">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/" className="text-2xl font-bold text-indigo-700 tracking-wide hover:scale-105 transition">
            AVANI ENTERPRISES
          </Link>
              ...
              <>
                {user.role === 'hr' && (
                  <>
                    ...
                    <NavLink to="/hr/manage-employees" style={({ isActive }) => isActive ? activeLinkStyle : undefined} className="nav-item">Manage Employees</NavLink>
          ...
          <div className="md:hidden flex items-center">
            ...
            >
              {isMobileMenuOpen ? (
                ...
                <svg className="w-6 h-6" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16m-7 6h7" /></svg>
              )}
            </button>
          </div>
        </div>
